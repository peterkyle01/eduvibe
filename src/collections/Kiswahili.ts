...
export const Kiswahili: CollectionConfig = {
  slug: 'kiswahiliQuestion',
  admin: {
    useAsTitle: 'Question',
    description: 'This is the Kiswahili subject for all the Grade classes.',
  },
  fields: [
    {
      name: 'Question Image',
